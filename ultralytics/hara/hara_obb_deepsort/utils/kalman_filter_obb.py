...
class KalmanFilterOBB(object):
    ...
    def initiate(self, measurement):
        ...
        std = [
            2 * self._std_weight_position * measurement[2],  # cx uncertainty
            2 * self._std_weight_position * measurement[3],  # cy uncertainty
            2 * self._std_weight_position * measurement[2],  # w uncertainty
            2 * self._std_weight_position * measurement[3],  # h uncertainty
            2 * self._std_weight_angle * 180,               # angle uncertainty (in degrees)
            10 * self._std_weight_velocity * measurement[2], # vcx uncertainty
            10 * self._std_weight_velocity * measurement[3], # vcy uncertainty
            10 * self._std_weight_velocity * measurement[2], # vw uncertainty
            10 * self._std_weight_velocity * measurement[3], # vh uncertainty
            10 * self._std_weight_angle * 180                # vangle uncertainty
        ]
    ...
    def predict(self, mean, covariance):
        ...
        """
        std_pos = [
            self._std_weight_position * mean[2],  # cx
            self._std_weight_position * mean[3],  # cy
            self._std_weight_position * mean[2],  # w
            self._std_weight_position * mean[3],  # h
            self._std_weight_angle * 180          # angle
        ]
        std_vel = [
            self._std_weight_velocity * mean[2],  # vcx
            self._std_weight_velocity * mean[3],  # vcy
            self._std_weight_velocity * mean[2],  # vw
            self._std_weight_velocity * mean[3],  # vh
            self._std_weight_angle * 180          # vangle
        ]
