...
if __name__ == '__main__':
    ...
    #
    # # # HBB10_reID
    # cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_reid\hold1_tracking.yaml")
    # start(show_window=False)
    # cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_reid\hold2_tracking.yaml")
    # start(show_window=False)
    # cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_reid\hold3_tracking.yaml")
    # start(show_window=False)
    # cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_reid\hold4_tracking.yaml")
    # start(show_window=False)
    # cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_reid\hold5_tracking.yaml")
    # start(show_window=False)
    # cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_reid\hold6_tracking.yaml")
    # start(show_window=False)
    #
    # # HBB10_detection_track_reID
    cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_detection_track_ReID\hold1_tracking.yaml")
    start(show_window=False)
    cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_detection_track_ReID\hold2_tracking.yaml")
    start(show_window=False)
    cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_detection_track_ReID\hold3_tracking.yaml")
    start(show_window=False)
    cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_detection_track_ReID\hold4_tracking.yaml")
    start(show_window=False)
    cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_detection_track_ReID\hold5_tracking.yaml")
    start(show_window=False)
    cfg.merge_from_file(r"C:\Users\tliu25\workspace\ultralytics\ultralytics\hara\hara_report\large_model\HBB10min_detection_track_ReID\hold6_tracking.yaml")
    start(show_window=False)
    #
